...
<div id="wrap">
	<div id="list_wrap">
		<div class="list_menu">
			...
			<ul>
				<li class="list_proposal"><a href="commWroteAll.do">작성 글</a></li>
				<li class="list_position"><a href="commReplyWrote.do">작성 댓글</a></li>
				<li class="list_position"><a href="likeListsComm.do">좋아요 한 글</a></li>
			</ul>
		</div>

		<div class="list_contents">
			<p class="list_sub_title">작성 글</p>
			...
			<div class="list_search">
				<div class="comm_item_bot_Left">
					<a href="#" class="comm_wanted_modify" id="deleteBtnComm" onclick="check_selectDel();">선택 삭제</a>
				</div>			
			</div>
								...
								<tr>
									...
									<td>
										<div class="comm_item_bot">
											<a href="boardUpdateForm.do?commNo=${commInfoVOs.commNo}" class="comm_wanted_modify">수정</a>
										</div>
									</td>
									<td>
										<div class="comm_item_bot">
											<a href="#" class="comm_wanted_modify" onclick="selectOneDel('${commInfoVOs.commNo}');">삭제</a>
										</div>
									</td>
								</tr>
							</c:forEach>
